...
(function() {
  ...
  Ogg = require("./http/ogg").Ogg;

  ExpressHandler = (function() {
    function ExpressHandler(app, opts) {
      this.app = app;
    ...
    ExpressHandler.prototype.addSource = function(mount) {
      var _this = this;
      return function(req, res, next) {
        ...
        return _this.auth(req, res, function() {
          ...
          switch (mime) {
            ...
            case "audio/ogg":
            case "video/ogg":
              handler = new Ogg.HttpHandler(_this.app, mount);
              break;
            default:
              return res.send(501);
          }
  ...
  module.exports = {
    enableServer: function(app, opts) {
      return new ExpressHandler(app, opts);
    }
  };
